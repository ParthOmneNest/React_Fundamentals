...
// Pick<T,K>:- keep ONLU these fields from Stock
...
interface TradeFormProps{
    stocks: StockSummary[], // pick only fields whic are needed
    onSubmitTrade: (trade: NewTradeInput) => void, // omit- no id/date yet
    initialValues?: EditableStock // partial - prefill form optionally
}
export const TradeForm: React.FC<TradeFormProps>=({
    ...
    // If initialValues.symbol is "AAPL", the result is "AAPL".
    // If initialValues.symbol is null or undefined, the result is '' (empty string).
